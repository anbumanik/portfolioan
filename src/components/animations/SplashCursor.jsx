...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    addListener(document.body, 'mousemove', function handleFirstMouseMove(e) {
      const rect = canvas.getBoundingClientRect();
      if (e.clientX < rect.left || e.clientX > rect.right || e.clientY < rect.top || e.clientY > rect.bottom) return;
      let pointer = pointers[0];
      let posX = scaleByPixelRatio(e.clientX - rect.left);
      ...
      if (!animationFrameId) updateFrame();
    ...
    addListener(document.body, 'touchstart', function handleFirstTouchStart(e) {
